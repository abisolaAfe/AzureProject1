...
const AssignAzureRoleButton = () => {
    ...
    const assignRoleToUser = async (roleId) => {
        ...
        try {
            ...
            // Schedule a function to remove the role assignment after 10 minutes
            setTimeout(() => {
                removeRoleAssignment(subscriptionId, assignmentId);
    ...
    const removeRoleAssignment = async (subscriptionId, assignmentId) => {
        const url = `https://management.azure.com/subscriptions/${subscriptionId}/providers/Microsoft.Authorization/roleAssignments/${assignmentId}?api-version=2020-04-01-preview`;
        ...
        try {
            ...
            console.log('Role assignment removed successfully:', response.data);
        } catch (error) {
            console.error('Error removing role assignment:', error.response ? error.response.data : error.message);
        }
    };
